...
// -------------------------------------------------------------buy button ki event or process 

const  moveToBuyList=(index)=>{
    let bookList = JSON.parse(localStorage.getItem('book-list')) || [];
...
// -------------------------------------------------------------------------------- click bookmark
const moveToBookmarkList =(index)=> {
    let bookList = JSON.parse(localStorage.getItem('book-list')) || [];
...
// --------------------------------------------------------- click buy button to add bookmark 
...
// ------------------------------------------click bookmark to display in bookmark table
const renderBookmarkTable=()=>{
    let bookmarkList = JSON.parse(localStorage.getItem('bookmark-list')) || [];
