    ...
    const renderTable=()=> {
        ...
        courses.forEach((course, index) => {
            ...
            actionCell.innerHTML = `
                ...
                <button onclick="purchaseCourse(${index})">Purchase product</button>
            `;
        });
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const renderTable=()=> {
        ...
        courses.forEach((course, index) => {
            ...
            img.addEventListener("click", function() {
                ...
                window.location.href = "/pages/course_details.html";
            });
    ...
    window.showDetails = function(index) {
        alert(`product: ${courses[index].course}\nTitle: ${courses[index].course_title}\nSub-title: ${courses[index].subTitle}\nprice: ${courses[index].fees}\nDiscount price: ${courses[index].disscountFees}`);
    };
